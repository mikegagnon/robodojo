...
class Config(params: Map[String, Any]) {
  ...
  object viz {
    ...
    val framesPerSecond = params.getOrElse("viz.framesPerSecond", 1).asInstanceOf[Int]
    val cyclesPerSecond = params.getOrElse("viz.cyclesPerSecond", 1).asInstanceOf[Int]
