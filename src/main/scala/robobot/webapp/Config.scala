...
class Config(params: Map[String, Any]) {
  ...
  object viz {
    ...
    val framesPerSecond = params.getOrElse("viz.framesPerSecond", 10).asInstanceOf[Int]
    val cyclesPerSecond = params.getOrElse("viz.cyclesPerSecond", 10).asInstanceOf[Int]
